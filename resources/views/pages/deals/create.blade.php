...
@section('script')
<script src="/assets/js/page-create-deal.min.js?v={{ config('app.version', '1.0.0') }}"></script>
@endsection
...
<p class="text-muted">Complete this form to create a new deal</p>
...
<form>
    ...
    <!-- Button -->
    <div class="mt-5">
        <button type="button" class="btn btn-primary button-create-deal me-3">Create Deal</button>

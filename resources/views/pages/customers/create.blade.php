...
<form>
    ...
    <div class="row">
      ...
      <div class="col-12">
        <div class="form-group">
          ...
          <div class="dropdown">
            ...
            <div>
              <input type="hidden" class="deal-loaded" value="" />
      ...
      <div class="col-12">
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="mk" placeholder="MK" />
        </div>
      </div>
        ...
        <div class="form-group">
          ...
          <div class="col-12">
            ...
            <div class="form-check">
              <input class="form-check-input" type="radio" name="product" value="MORTGAGE" id="product-mortgage" />
            ...
            <div class="form-check">
              <input class="form-check-input" type="radio" name="product" value="LIFE INSURANCE" id="product-life-insurance" />
            ...
            <div class="form-check">
              <input class="form-check-input" type="radio" name="product" value="B AND C" id="product-b-and-c" />
    ...
    <!-- Button -->
    <div class="mt-5">
        <button type="button" class="btn btn-primary button-create-customer me-3">Create Customer Account</button>

(function () {
    ...
    var renderError = function (errorMessage) {
        document.querySelector('#commissionsList').innerHTML = '<div class="p-5">' +
    ...
    var fullRefresh = function () {
        ...
        document.querySelector('#commissionsList').innerHTML = '';
        ...
        Commissions.load({ dates: dateFilter, customer: customerFilter })
        .then(function (commissionsData) {
            Commissions.draw({
